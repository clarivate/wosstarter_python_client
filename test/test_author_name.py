...
class TestAuthorName(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> AuthorName:
        """Test AuthorName
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AuthorName`
        """
        model = AuthorName()
        if include_optional:
            return AuthorName(
